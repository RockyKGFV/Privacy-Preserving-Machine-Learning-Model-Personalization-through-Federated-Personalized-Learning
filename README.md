...
The CIFAR-10 dataset is partitioned across multiple clients using a **Dirichlet distribution** to simulate realistic non-IID federated environments.
...
A lightweight Convolutional Neural Network (CNN) is used for CIFAR-10 classification.
...
The project automatically generates several plots after training.

## Global vs Personalized Accuracy
Shows convergence trends across communication rounds.

## Personalization Gap
Shows whether personalization improves performance.

## Client Variance
Measures heterogeneity across client performance.

## Combined Visualization
Includes confidence bands using standard deviation.
...
- Successful federated convergence
- Impact of non-IID data
- Stability improvements using FedProx
- Tradeoffs between global generalization and personalization

In highly heterogeneous settings, personalization provides noticeable improvements for local clients. However, FedProx constrains excessive client drift, improving overall stability while reducing aggressive personalization effects.
...
| Round | Global Accuracy | Personalized Accuracy |
|------|----------------|-----------------------|
| 1 | 0.2996 | 0.3490 |
| 2 | 0.4196 | 0.3828 |
| 3 | 0.4386 | 0.4264 |
